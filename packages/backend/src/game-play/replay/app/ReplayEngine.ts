...
import { CombatResult } from '@/game-play/combat/interfaces/combat-engine/CombatResult'
import { CombatLogEntry } from '@/game-play/combat/interfaces/logger/CombatLogEntry'
import { CombatSnapshot } from '@/game-play/combat/interfaces/combat-engine/CombatSnapshot'
/**
 * ReplayEngine
 *
 * 最小 API，方便 UI 整合：
