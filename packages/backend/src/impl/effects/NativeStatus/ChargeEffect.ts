...
import { ChargeEffectConfig, EffectNames } from '@/game-play/combat/domain/config/EffectConstants'
import { TickConfig } from '@/game-play/combat/domain/config/FormulaConstants'
/**
 * Charge effect
