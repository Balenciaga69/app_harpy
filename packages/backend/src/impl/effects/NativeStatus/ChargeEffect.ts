...
import { ChargeEffectConfig, EffectNames } from '@/features/game-play/combat/domain/config/EffectConstants'
import { TickConfig } from '@/features/game-play/combat/domain/config/FormulaConstants'
/**
 * Charge effect
