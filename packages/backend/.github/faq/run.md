...
- 拆分為多個獨立的 JSON 欄位
  - run_context, character_context, stash_context, more... 等等
  - 並行更新效率更高
  - 易於查詢和序列化
...
- 每個 context 都有自己的 version 欄位
  - RunContext.version
  - CharacterContext.version
  - StashContext.version
...
- 外部專案 (NestJS + DocumentDB或其他可能的技術實踐) 實作
  - 版本號比對邏輯
