...
- 思考從原本的 PoeLike Roll 裝備系統與 LOL 的固定裝備系統哪種更適合 RogueLike遊戲
...
- 構思有沒有一套做法可以 不論將其視為前端、後端、後端模組都能正常溝通的使用方式。
- Claude Sonnet 4.5 生成了 庫存、角色管理、敵人生成系統
...
- 添加了 License 到專案，在我搞懂法律與授權之前。先一律禁止嚴格商業用途。(我這個專案目的是用於當面是作品集與自用，商業用途會讓我很頭痛)
- 構思戰前變局系統(TFT戰棋開局奇遇)與復活系統(HP歸0後有機率復活)
