...
import { DamageChain } from '@/logic/combat/logic/damage'
import type { IUltimateAbility } from '@/logic/combat/domain/ultimate/ultimate-ability'
import { UltimateDefaults } from '@/logic/combat/infra/config'
import { FirstAliveSelector } from '@/logic/combat/coordination'
import { DamageFactory } from '@/logic/combat/coordination/utils/DamageFactory'
/**
