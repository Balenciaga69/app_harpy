...
const profession_warrior: ProfessionTemplate = {
  ...
  desc: { tw: "力量與決心的化身。擁有強大的單體傷害技能，能承受更多傷害。", en: "An embodiment of strength and determination. Possesses powerful single-target damage skills and can endure more damage." },
