...
- 導入 nestjs 限流與 jwt 官方套件, 棄用自製代碼

## _2025/01/13_

- 研究 JWT 與 資安風險與最佳授權系統實踐

## _2025/01/12_

- 修正 Redis, JWT 等 AI 生成的相關代碼
- 研究測試 api 有沒有高效迅速的方式
- 導入 env 變數管理
...
- 添加 Redis 取代測試用的 In-Memory Cache, 以便多實例存取共享資料
...
- 重新理解 monorepo 與多 package 專案的專案如何管理

## _2025/01/04_

- 初步建立 NestJs 後端以串接遊戲核心邏輯
