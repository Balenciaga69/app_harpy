...
import { StackableEffect } from '@/core/combat/domain/effect/models/stackable-effect'
...
import { EffectNames, ChargeEffectConfig, TickConfig } from '@/core/combat/infra/config'
/**
 * Charge effect
